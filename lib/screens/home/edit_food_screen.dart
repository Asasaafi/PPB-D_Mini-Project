...
class _EditFoodScreenState extends State<EditFoodScreen>
  ...
  void initState() {
    ...
    _notesController = TextEditingController(text: widget.food.notes ?? '');
    _selectedDate = widget.food.expiryDate;
  ...
  Widget _buildImagePicker() {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: _hasPhoto ? _buildImagePreview() : _buildImagePlaceholder(),
      ),
    );
  }
